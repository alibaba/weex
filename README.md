...
* Install [Weex Playground App](http://alibaba.github.io/weex/download.html) to see samples we already written.
...
* Run `weex init` to generate & start a sample project in an empty folder.
