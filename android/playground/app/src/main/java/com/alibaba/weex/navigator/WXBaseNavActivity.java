...
public abstract class WXBaseNavActivity extends WXBaseActivity implements IWXRenderListener, Handler.Callback, View.OnClickListener {
    ...
    private void initToolbar() {
        ...
        leftItem.btn.setOnClickListener(this);
        rightItem.btn.setOnClickListener(this);
        rightItem.titleView.setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.leftItem:
                //TODO notify js leftItem clicked
                break;
            case R.id.rightItem:
                //TODO notify js rightItem clicked
                break;
            case R.id.rightTitleView:
                //TODO notify js rightItem clicked
                break;
        }
    }
        ...
        WXSDKEngine.setActivityNavBarSetter(new WXNavigatorAdapter(new WXNavigatorAdapter.NavigatorCallBack() {
            ...
            public void onSetNavBarRightItem(String imgPath, String title, String titleColor, boolean fromNative) {
                ...
                if (fromNative) {
                    ...
                    rightItem.setIconBitmap(imgPath, getActionBarHeight());
                }
            ...
            public void onSetNavBarLeftItem(String imgPath, String title, String titleColor, boolean fromNative) {
                ...
                if (fromNative) {
                    ...
                    leftItem.setIconBitmap(imgPath, getActionBarHeight());
                }
