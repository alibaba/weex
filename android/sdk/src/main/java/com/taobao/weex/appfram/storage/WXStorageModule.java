...
public class WXStorageModule extends WXModule implements IWXStorage {
    ...
    private IWXStorage mStorageAdapter;


    private IWXStorage ability(){
        ...
        if(mWXSDKInstance == null){
            WXLogUtils.e("WXStorageModule","No IWXStorageAdapter found,request failed.");
            return null;
        }

        adapter = new DefaultWXStorage(mWXSDKInstance.getContext());
        mStorageAdapter = new WXStorageWrapper(adapter);
        return mStorageAdapter;
    }
