...
public class TypefaceManager {
    private final static Map<String, List<String>> sTextDomRefMap = new HashMap<>();

    public static void initRefs(String family) {
        sTextDomRefMap.put(family, new ArrayList<String>());
    }

    public static void clearRefs(String family) {
        sTextDomRefMap.remove(family);
    }

    public static void putRef(String family, String ref) {
        List<String> refs = sTextDomRefMap.get(family);
